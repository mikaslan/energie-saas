-- F10-03c Commercial-Scope: resolve_portal_public_view projiziert
-- zusaetzlich project.scope (kanban_board.scope des Projekt-Boards).
-- Katalog F10.3: kein Preis-/Signatur-Bereich im Commercial-Portal;
-- der Contract leert documents bei scope commercial, die Seite blendet
-- den Dokumentenbereich aus. Funktions-Pin im Rollenvertrag
-- nachgezogen (Hash aus diesem Body).

-- Owner-sicherer Funktionsersatz (Muster 0091/0059/0056).
DO $f1003c_replace_resolver$
DECLARE
...
$f1001_resolve_token$;$ddl$;
  ...
  END IF;
END
$f1003c_replace_resolver$;--> statement-breakpoint
...
BEGIN
  ...
  END IF;
END
$f1003b_grants$;--> statement-breakpoint
