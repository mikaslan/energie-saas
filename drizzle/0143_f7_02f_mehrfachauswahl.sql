-- F7-02f: Mehrfachauswahl (Katalog F7.2, Slice B neben Radio/Freitext).
-- Validator erlaubt `kind = 'multi'` je Punkt (abhakbar wie Aufgabe,
-- OHNE Segment-Exklusivitaet — Gegenstueck zu F7-02D). Keine neue Tabelle,
