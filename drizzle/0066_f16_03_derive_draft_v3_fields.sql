-- ═══════════════════════════════════════════════════════════════════════
-- F16.3 Slice D/E Nachzug: DB-seitige Input-Ableitung spiegelt den
-- TS-v3-Vertrag. Der Trigger derive_offer_pdf_draft_input (0033) baute
-- commercialTerms ohne Fix-/Cap-Felder -> validateOfferPdfDraftInput
-- schlug auf DB-seitig abgeleiteten Drafts fehl (m202, nachgemessen in
-- Gatefix-Pass 3, dort 0065 mit nur Fix — hier v3-vollständig mit Cap).
-- CREATE OR REPLACE ohne Owner-Tanz: Trigger-Funktion, INVOKER, Owner
-- bleibt erhalten (Migrationsrolle wie 0033); Rollenpin nachgezogen.
-- ═══════════════════════════════════════════════════════════════════════
