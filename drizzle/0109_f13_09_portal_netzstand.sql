-- ═══════════════════════════════════════════════════════════════════════
-- F13-09 Netzstand im Kundenportal (Katalog F13.2-Folge): Die
-- Portal-Projektion zeigt je aktivem Invite den Stand der Netzanmeldung
-- (Status/Betreiber/Phasen-Daten, nie Zaehlernummer). Reine
-- Leseprojektion des DEFINER-Resolvers (Muster 0106/0107); keine
-- Schreibpfade, keine neuen Rechte.
-- ═══════════════════════════════════════════════════════════════════════
...
BEGIN
  ...
  END IF;
END
$f1009_grants$;--> statement-breakpoint
