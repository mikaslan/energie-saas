-- F7-15: Fotodoku-Batch (Katalog F7.8: bis zu 8 Fotos je Bild-Punkt
-- als `photos`-Array; `photo` bleibt das Cover = photos[0] sobald
-- photos non-empty, sonst wie heute).
-- Vollkopie von 0178 plus `photos` (Allowlist + Array-Regel +
-- Struktur-Strip). Signatur traegt nie `photos`. Keine neue Tabelle,
-- keine neue Permission (checklist.write/read), keine RLS-Aenderung,
-- kein Backfill (Legacy: photos null, photo wie heute).
-- (Folgezeilen wortgleich zu 0178 bis auf die photos-Stellen.)
