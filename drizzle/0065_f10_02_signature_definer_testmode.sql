-- ═══════════════════════════════════════════════════════════════════════
-- F10.2 Slice B Nachzug: öffentliche Signatur-DEFINER im
-- Ein-Rollen-Testmodus funktionsfähig machen. Port von Gatefix-Pass 3
-- (f95c106, dort 0064 — hier 0065, da 0064 der v3-Check ist).
--
