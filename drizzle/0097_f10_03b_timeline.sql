-- F10-03b Status-Timeline — resolve_portal_public_view projiziert
-- zusaetzlich installation.timeline ([{type, at}], nur Allowlist-Typen,
-- nie Payloads/Akteure; lead_installer_assigned bleibt intern).
-- Funktions-Pin im Rollenvertrag nachgezogen (Hash aus diesem Body).

-- Owner-sicherer Funktionsersatz (Muster 0091/0059/0056).
DO $f1003b_replace_resolver$
DECLARE
...
$f1001_resolve_token$;$ddl$;
  ...
  END IF;
END
$f1003b_replace_resolver$;--> statement-breakpoint
