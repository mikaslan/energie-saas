-- ═══════════════════════════════════════════════════════════════════════
-- F16.3 Slice D Nachzug (Gatefix-Pass 3): DB-seitige Input-Ableitung
-- spiegelt den neuen TS-Vertrag. Muse hatte das Pflichtfeld
-- globalFixDiscountCents nur im TS-Contract ergaenzt; der Trigger
-- derive_offer_pdf_draft_input (0033) baute commercialTerms weiter
-- ohne das Feld -> validateOfferPdfDraftInput schlug auf DB-seitig
-- abgeleiteten Drafts fehl (m202-Strict-Test, nachgemessen).
