      ...
      <section className="w-full max-w-3xl overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
        <div className="grid gap-8 p-8 sm:p-12">
          <div className="flex items-center gap-3">
            <span className="grid size-10 place-items-center rounded-md bg-brand-700 text-sm font-bold text-white" aria-hidden="true">
              W
            </span>
            <div>
          ...
          <div>
            <Link
              href="/login"
              className="inline-flex min-h-11 items-center justify-center rounded-md bg-slate-900 px-5 text-sm font-semibold text-white outline-none hover:bg-slate-700 focus:ring-2 focus:ring-brand-500 focus:ring-offset-2"
            >
              Zum Login
            </Link>
          </div>
