...
export interface OfferDetailSurfaceView {
  ...
  // F16.3 Slice C/D: Vorlagen für den Global-Rabatt-Dropdown (cap-freie
  // Prozent- + Fix-Vorlagen aus Rabatt + Förderung). Nur mit discount.apply.
...
function VariantNavigation({ variants }: { variants: readonly OfferVariantTabView[] }) {
  return (
    <nav aria-label="Angebotsvarianten" className="block">
      <ul className="flex flex-wrap list-none gap-2 pb-1">
