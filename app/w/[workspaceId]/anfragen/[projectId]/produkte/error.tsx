  ...
  return (
    <main className="mx-auto flex min-h-[70vh] w-full max-w-3xl items-center px-6 py-12">
      <section className="w-full rounded-lg border border-red-200 bg-red-50 p-6 sm:p-8">
        ...
        <h1 className="mt-2 text-2xl font-semibold text-slate-950">Die Produktauflösung konnte nicht geladen werden.</h1>
        <p className="mt-3 text-sm leading-6 text-slate-700">Es wurden keine Produkte bestätigt oder verändert.</p>
