  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-950">
      <div className="mx-auto w-full max-w-4xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
        ...
        <header className="rounded-xl border border-brand-200 bg-brand-50 p-5 sm:p-7">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="min-w-0">
              <p className="text-sm font-semibold text-brand-800">Zugewiesene Anfrage</p>
            ...
            <span className="rounded-full border border-brand-300 bg-white px-3 py-1.5 text-xs font-semibold text-brand-900">
              Nur Lesezugriff
            </span>
          </div>
