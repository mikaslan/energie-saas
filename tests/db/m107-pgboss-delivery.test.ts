    ...
    expect(routineAcl.rows).toEqual([
      {
        grantee: "app_runtime",
        grantor: "app_worker",
        signature: "enqueue_catalog_import_cleanup_v1(uuid, uuid, uuid)",
      ...
      },
      {
        grantee: "app_runtime",
        grantor: "app_worker",
        signature: "enqueue_catalog_import_v1(uuid, uuid, uuid)",
        privilege_type: "EXECUTE",
        is_grantable: false,
      },
      {
        grantee: "app_runtime",
        grantor: "app_worker",
        signature: "enqueue_customer_notification(uuid, uuid)",
        privilege_type: "EXECUTE",
        is_grantable: false,
      },
      {
        grantee: "app_runtime",
        grantor: "app_worker",
        signature: "enqueue_draft_pdf_render(uuid, uuid)",
        privilege_type: "EXECUTE",
        is_grantable: false,
      },
      {
        grantee: "app_runtime",
        grantor: "app_worker",
        signature: "enqueue_invoice_pdf_render(uuid, uuid)",
        privilege_type: "EXECUTE",
        is_grantable: false,
      },
      {
        grantee: "app_runtime",
        grantor: "app_worker",
        signature: "enqueue_lead_score_recompute(uuid, uuid)",
        privilege_type: "EXECUTE",
        is_grantable: false,
      },
      {
      ...
      },
      {
        grantee: "app_runtime",
        grantor: "app_worker",
        signature: "enqueue_offer_release_candidate(uuid, uuid)",
        privilege_type: "EXECUTE",
        is_grantable: false,
      },
      {
