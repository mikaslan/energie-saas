...
//   danach F6-01 Schaltplan-Diagramme (0300),
//   danach F6-02a Editor-Overlays (0301).
// => 163 Migrationen (idx 0..162, HEAD 0301 F6-02a Editor-Overlays).
const TOTAL_MIGRATION_COUNT = 163;
