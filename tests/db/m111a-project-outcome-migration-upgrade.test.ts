...
//   F8-16 Teilrechnungstypen-Kennung (0190, Spalte + CHECKs + Guard)
//   M3-02a Zeilen-Freeze-Guard (0191, Funktion + 3 Trigger)
// => 151 Migrationen (idx 0..150).
const TOTAL_MIGRATION_COUNT = 151;
