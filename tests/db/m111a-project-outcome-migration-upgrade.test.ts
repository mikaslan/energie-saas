...
// + F5-01 Skonto (0082) => 83 Migrationen (idx 0..82).
// + F8-01 Anzahlung-Link (0083), F9-05 Zeitfreigabe (0084),
//   F7-05 Abnahme (0085), F13-01 Serviceauftrag (0086)
// => 87 Migrationen (idx 0..86).
// + F8-02 Teilanrechnung (0090), F10-03 Installation-Tab (0091),
//   F16-04 Aufgaben-Vorlagen (0092), F9-07 Abrechnungslauf (0093),
//   F16-05 Termin-Vorlagen (0094), F16-06 Angebots-Vorlagen (0095)
// => 96 Migrationen (idx 0..95).
// + F7-05 Lead-Installer (0096), F10-03b Timeline (0097),
//   F10-03c Commercial-Scope (0098), F1-05a Column-Grants (0099),
//   F1-05b Conversion-Ratio (0100), F1-06 Follow-up (0101),
...
//   F13-09 Netzstand-Portalprojektion (0109),
//   F16-07 Datei-Anfragen-Vorlagen (0110),
//   F11-03a Notiz-Outbox (0111), F11-03b Zeit-Outbox (0112),
...
//   F7-13 Vorlagen-Identitaet (0131, Validator-Shape),
...
//   F10-12 Download-Protokoll (0137, Tabelle + RLS + DEFINER-Replace),
//   F16-09 Förder-Preset (0138, Spalte + FK + CHECK),
//   F16-10 E-Mail-Vorlagen (0139, Tabelle + RLS),
//   F10-02c Portal-Signatur-Kapseln (0140, Funktionen + Owner-Tanz),
//   F7-02d Radio-Einfachauswahl (0141, Validator-Replace),
//   F7-02e Freitext-Antwort (0142, Validator-Replace),
...
//   danach F6-01/02a nachjournaliert (0300/0301, Files aus 5I-Lane, nie im Journal gewesen),
//   danach F1-26 Notiz-Team-Mentions (0321, Seitentabelle).
// => 178 Migrationen (idx 0..177, HEAD 0321 F1-26 Notiz-Team-Mentions).
const TOTAL_MIGRATION_COUNT = 178;
