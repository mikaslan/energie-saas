...
| ID | Klasse | Frage / Konflikt | Behandlung bis M2-03a | Abschlussgate |
|---|---|---|---|---|
...
| `UNK-F2-09` | UNKNOWN | genaue private Reonic-PDF-Struktur, Rundung, Firmen-/Rechtsdaten, Issuance sowie autoritative WMEE-Angebotsvorlage/Claim-Regeln | M2-03a implementiert ausschließlich eine eigene WMEE-Informationsarchitektur und versionierbare, zunächst inhaltsleere Aussteller-/Rechtstextprofile. Der Candidate trägt auf jeder Seite `nicht ausgestellt · nicht versendet`; private Reonic-Layouts/-Regeln, echte Texte, Claims, Issuance und verbindliche Kundenvorlage bleiben unbekannt | echte WMEE-Inhalte + Legal-/Claim-/Owner-Review und menschliche `M203A-VISUAL-01`-Baseline vor Issuance |
| `UNK-F2-10` | CONFLICTING | Wann wird Online-Annahme/Signatur bindend, wer darf ausstellen/freigeben, ob Vier-Augen Pflicht ist, welche Revision den Vertrag bildet und wie Delivery/Installation folgt | M2-03a bindet eine interne Selbstfreigabe an echte Candidate-Bytes, erzeugt aber nur `approved_not_issued`; kein Versand, keine Annahme, Signatur oder Installationsautomation | M2-03b-Issuance- sowie spätere Delivery-/Signatur-Spec mit Legal-/Owner-/Interview-Freigabe |
...
| `UNK-F2-12` | UNKNOWN | issued/signed Retention versus DSGVO-Erasure | M2-03a staged auch Candidate-Bytes höchstens 8 MiB tenantgeschützt und Offer-löschbar in Postgres; aktive Render-Lease blockiert Erasure. Profilhistorie bleibt Workspace-weit, Candidate/Approval bleibt Offer-lokal. Kein WORM/Object Lock und keine Retention-Behauptung | Legal/DSGVO, produktiver Object-Lock-Kauf/-Provisionierung, Retention-/Version-/Hash-Readback und Promotionsvertrag vor Issuance |
...
| `UNK-DESIGN-01` | UNKNOWN | authentische WMEE-Farben, Typografie und freigegebene Screenshot-/PDF-Baseline | eigene scoped Grünrichtung und vollständige Tokens sind Gate-1-freigegeben; 320 als Reflow-Stress sowie 375/390/768/1024/1440/1920 und 44 px sind A11y-/QA-Entscheidungen, keine Brand-Evidenz. M2-02/M2-03a verwenden ausschließlich eigene WMEE-Tokens/Systemfonts; `M201-VISUAL-01`, `M202-VISUAL-01` und `M203A-VISUAL-01` bleiben ohne menschliche Baseline `INCONCLUSIVE` | Mikails Portal- und gerasterte PDF-Baseline-/Brandfreigabe |
| `UNK-PDF-01` | UNKNOWN | formale PDF/UA-Konformität, vollständige Tag-Struktur, Lesereihenfolge und Assistive-Technology-Verhalten realer Mehrseiter | Rendereroption, Struktur-Smoke, A4 und Pflichtstatus auf 11/11 Seiten sind technisch grün; das ist kein formaler PDF/UA- oder Barrierefreiheitsnachweis | PDF/UA-Validator plus manueller Screenreader-/Dokument-A11y-Review vor externem Versand |
| `UNK-OPS-01` | UNKNOWN | produktiver Worker-/Web-Deploy, Zielhost-Rollback, Monitoring, reale Queue-Recovery und Betriebs-SLO | lokale Tests, Build und gepinnter Container sind grün; es erfolgte kein Deploy und keine Mutation externer Infrastruktur | autorisierter Staging-/Produktionsdeploy mit Smoke, Monitoring, Backup/Restore und Rollback |
