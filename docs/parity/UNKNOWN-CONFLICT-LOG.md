...
| ID | Klasse | Frage / Konflikt | Behandlung bis M2-02 | Abschlussgate |
|---|---|---|---|---|
...
| `UNK-F2-09` | UNKNOWN | genaue private Reonic-PDF-Struktur, Firmen-/Rechtsdaten, Issuance sowie autoritative WMEE-Angebotsvorlage/Claim-Regeln | M2-02 entscheidet nur eine eigene WMEE-A4-Struktur für einen sichtbar internen, nicht verbindlichen Draft aus exakt einer Revision; Firmen-/Rechtsdaten, Claims, Issuance und verbindliche Kundenvorlage bleiben bewusst außen vor | menschliche `M202-VISUAL-01`-Baseline; danach Rechtsdaten + Claim-/Owner-Review vor Issuance |
| `UNK-F2-10` | CONFLICTING | Wann wird Online-Annahme/Signatur bindend, wer darf freigeben, welche menschliche Prüfung und welche Revision bildet den Vertrag; danach automatische oder manuelle Installation | M2-02 erzeugt nur Draft-Bytes und ändert keinen Offer-/Vertragsstatus; kein Versand, keine Annahme und keine Signatur | M2-03 Legal-/Owner-/Interview-Spec |
...
| `UNK-F2-12` | UNKNOWN | issued/signed Retention versus DSGVO-Erasure | M2-02 staged höchstens 8 MiB als tenantgeschützten, mit dem Offer löschbaren Draft in Postgres; eine aktive Render-Lease blockiert Erasure, autonome Workerzeiten verlängern die Inaktivitätsfrist nicht; kein WORM/Object Lock | Legal/DSGVO, produktiver Object-Lock-Kauf/-Readback und Promotionsvertrag vor Issuance |
...
| `UNK-DESIGN-01` | UNKNOWN | authentische WMEE-Farben, Typografie und freigegebene Screenshot-/PDF-Baseline | eigene scoped Grünrichtung und vollständige Tokens sind Gate-1-freigegeben; 320 als Reflow-Stress sowie 375/390/768/1024/1440/1920 und 44 px sind A11y-/QA-Entscheidungen, keine Brand-Evidenz. M2-02 verwendet ausschließlich eigene WMEE-Tokens/Systemfonts; `M201-VISUAL-01` und `M202-VISUAL-01` bleiben ohne menschliche Baseline `INCONCLUSIVE` | Mikails Screenshot- und PDF-Baseline-Freigabe |
