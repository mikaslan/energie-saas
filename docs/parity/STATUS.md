...
|---|---|---|
| F1 CRM & Leads | PARTIAL VERIFIED | Rechner-V3-Intake → Kontakt → Standort/Adresskorrektur → Anfrage → Kanban/Projektakte → Energieprofil → direkte Projektzuweisung mit minimierter External-Sicht → interne Projektaufgabe/Aktivität → Won/Lost/Reopen mit Verlustgrund und geschlossener Liste ist lokal real; als Nächstes Teams, Auto-Routing, globale Aufgabenansicht, Notizen, Termine, Funnel-Auswertung und weitere CRM-Capabilities |
