...
| F8 Rechnungen | PARTIAL VERIFIED | M3-00/M3-01 liefern Workspace-Grundlagen sowie den lokalen Rechnungs-/Dokumentkern. 2026-09-10 dazu (Lane-Labels F5-01/F5-02 gehoeren fachlich zu F8): Skonto-Konditionen + Berichts-CSV, read-only Belegdetail (Kopf/Betraege/Skonto/Positionen/Storno) und Anzahlung→Schlussrechnung-Anrechnung mit Restbetrag (Migration 0083, Strict-Rollenvertrag gruen). 2026-09-10 dazu: F8-02 Teilanrechnung (Betrag je Link, Default volles Brutto, Über-Anrechnung fail-closed, Rest aus Σ applied, Migration 0090; DB F802 3/3, E2E F8-02-E2E-01 1/1 lokal beobachtet). 2026-09-11 dazu: F8-03 Anzahlungs-Split (eine Anzahlung auf mehrere Finals, Σ-Deckel je Anzahlung, Kandidaten-Rest, Allokationen am Beleg, ohne Migration; DB F0803 4/4, E2E F8-03-E2E-01 1/1 lokal beobachtet). Offen bleiben mehrstufige Ketten, Gutschrift-Anrechnung, DATEV-/E-Rechnung und Versand |
...
| F10 Kundenportal | PARTIAL VERIFIED | Das F10.1-Skeleton liefert aktivierbaren Einladungslink, Status und minimierte Dokumentsicht; F10.2 ergänzt Termine-Tab und Signatur-Status. 2026-09-10 dazu: F10-03 Installation-Tab (Stand Abgenommen/Abgeschlossen/In Ausführung aus F7-Projektion, ohne Namen/Notizen, Migration 0091; DB F1004 2/2, E2E F10-03-E2E-01 1/1 lokal beobachtet). Offen: Admin-Statusmapping, KfW/Netzanmeldung, My Files, File Requests, Sprachen, Uploads, Versand |
| F11 Mobile/PWA | PARTIAL VERIFIED (lokal) | F11-01 liefert das installierbare PWA-Skeleton (Manifest, 192/512-any + 512-maskable + 180-Touch-Icon, Theme-Farbe, iOS-Titel; Unit 5/5, E2E F11-01-E2E-01 1/1 lokal beobachtet 2026-09-10). Icon-Gestalt ist Hausmittel (ESTIMATE, kein Reonic-Asset). Offline-Outbox (Fotos/Checklisten/Zeit-Sync), Service Worker und Push bleiben Folge-Slices |
