...
| F9 Zeiterfassung | PARTIAL VERIFIED | F9.1 liefert Kategorien, manuelle Einträge und Liste/Summe; F9.2 ergänzt die fortbestehende Stoppuhr. 2026-09-10 dazu: F9-05 Zeitfreigabe (Approve/Unapprove je beendetem Eintrag, Freigegeben = unveränderlich, Migration 0084) sowie F9-06 Pausen-Segmente (Start/Ende-Protokoll je Eintrag, max. eine offene Pause, Summe daneben ohne Verrechnung, Migration 0089; DB F906 4/4, E2E F9-06-E2E-01 1/1 lokal beobachtet 2026-09-10). CI-Nachzug: F9.2-E2E-Summe als exaktes Delta gehärtet (Race mit F9-05-Eintrag im Voll-Parallel-Lauf, Beleg: CI-Artefakt „Summe: 3 Std. 30 Min."). Offen bleiben Idle-Details, Auswertung, Abrechnungslauf, Mobile-/Offline-Verhalten |
