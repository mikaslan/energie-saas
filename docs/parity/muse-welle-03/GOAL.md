...
Stand: F9.4 A–D + F10.2-A + F16.3-A implementiert (0060
Rabatt-Vorlagen, lokale Gates grün; CI pending — Billing-Block Q6).
Nächstes: pushen, dann M2-04-Status klären.
