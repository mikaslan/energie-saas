...
export interface PortalStrings {
  ...
  revokeKnown: string;
  revokeGone: string;
  // F2.8: Portal-Draw-Signatur (Canvas-Erfassung je Dokument).
  drawDisclosure: string;
  drawClear: string;
  drawSubmit: string;
  drawEmptyHint: string;
...
export const PORTAL_STRINGS: Record<PortalLang, PortalStrings> = {
  de: {
    ...
    drawDisclosure: "Unterschrift zeichnen",
    drawClear: "Löschen",
    drawSubmit: "Gezeichnet annehmen",
    drawEmptyHint: "Bitte zuerst im Feld unterschreiben.",
    drawKeyboardHint: "Ohne Maus oder Touchscreen stattdessen:",
  ...
  en: {
    ...
    drawDisclosure: "Draw signature",
    drawClear: "Clear",
    drawSubmit: "Accept with drawing",
    drawEmptyHint: "Please sign in the box first.",
    drawKeyboardHint: "Without a mouse or touchscreen, use instead:",
  ...
  cs: {
    ...
    drawDisclosure: "Nakreslit podpis",
    drawClear: "Smazat",
    drawSubmit: "Přijmout s kresbou",
    drawEmptyHint: "Nejprve se prosím podepište do pole.",
    drawKeyboardHint: "Bez myši nebo dotykové obrazovky použijte místo toho:",
  ...
  el: {
    ...
    drawDisclosure: "Σχεδιάστε την υπογραφή",
    drawClear: "Εκκαθάριση",
    drawSubmit: "Αποδοχή με σχέδιο",
    drawEmptyHint: "Υπογράψτε πρώτα στο πλαίσιο.",
    drawKeyboardHint: "Χωρίς ποντίκι ή οθόνη αφής, χρησιμοποιήστε αντ’ αυτού:",
  ...
  es: {
    ...
    drawDisclosure: "Dibujar firma",
    drawClear: "Borrar",
    drawSubmit: "Aceptar con dibujo",
    drawEmptyHint: "Firme primero en el recuadro.",
    drawKeyboardHint: "Sin ratón ni pantalla táctil, use en su lugar:",
  ...
  fr: {
    ...
    drawDisclosure: "Dessiner la signature",
    drawClear: "Effacer",
    drawSubmit: "Accepter avec dessin",
    drawEmptyHint: "Veuillez d'abord signer dans le cadre.",
    drawKeyboardHint: "Sans souris ni écran tactile, utilisez plutôt :",
  ...
  hu: {
    ...
    drawDisclosure: "Aláírás rajzolása",
    drawClear: "Törlés",
    drawSubmit: "Elfogadás rajzzal",
    drawEmptyHint: "Kérjük, először írjon alá a mezőben.",
    drawKeyboardHint: "Egér vagy érintőképernyő nélkül használja helyette:",
  ...
  it: {
    ...
    drawDisclosure: "Disegna la firma",
    drawClear: "Cancella",
    drawSubmit: "Accetta con disegno",
    drawEmptyHint: "Firmare prima nel riquadro.",
    drawKeyboardHint: "Senza mouse o touchscreen, utilizzare invece:",
  ...
  nl: {
    ...
    drawDisclosure: "Handtekening tekenen",
    drawClear: "Wissen",
    drawSubmit: "Accepteren met tekening",
    drawEmptyHint: "Onderteken eerst in het vak.",
    drawKeyboardHint: "Gebruik zonder muis of touchscreen in plaats daarvan:",
  ...
  pl: {
    ...
    drawDisclosure: "Narysuj podpis",
    drawClear: "Wyczyść",
    drawSubmit: "Akceptuj z rysunkiem",
    drawEmptyHint: "Najpierw podpisz się w polu.",
    drawKeyboardHint: "Bez myszy i ekranu dotykowego użyj zamiast tego:",
    invoicesHeading: "Faktury",
  ...
  ro: {
    ...
    drawDisclosure: "Desenați semnătura",
    drawClear: "Ștergeți",
    drawSubmit: "Acceptați cu desen",
    drawEmptyHint: "Mai întâi semnați în casetă.",
    drawKeyboardHint: "Fără mouse sau ecran tactil, folosiți în schimb:",
